...
{
    public partial class added_PatientModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeansOfIdentification = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InteractiveSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InteractiveSessions_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_InteractiveSessions_AspNetUsers_TherapistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InteractiveSessions_PatientId",
                table: "InteractiveSessions",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_InteractiveSessions_TherapistId",
                table: "InteractiveSessions",
                column: "TherapistId");
