...
namespace Bounce.Api.Notification.Wallet
{
    ...
    public class WalletMessageConsumer : IConsumer<WalletMessage>
    {
        ...
        //public WalletMessageConsumer(ILogger<WalletMessageConsumer> logger, SemaphoreSlim semaphore, bool isProcessing, object @lock, INotificationService notificationService, Microsoft.AspNetCore.Hosting.IHostingEnvironment hostingEnvironment, IEmalService emailService, SessionManager sessionManager, BounceDbContext context)
        //{
        //    _logger = logger;
        ...
        public Task Consume(ConsumeContext<WalletMessage> context)
        {
            ...
            var _paymnet = (IPaymentServices)message._paymentServices;
            _paymnet.ComfirmWalletTop(message.TrnxRef).ConfigureAwait(false);
